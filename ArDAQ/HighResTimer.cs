...
namespace ArDAQ
{
    ...
    public class HighResTimer
    {
        ...
        /// </summary>
        public event EventHandler<HighResTimerElapsedEventArgs> Elapsed;
        ...
        public HighResTimer(float interval)
        {
            Interval = interval;
        }
        ...
        private void ExecuteTimer()
        {
            ...
            while (_isRunning)
            {
                ...
                Elapsed?.Invoke(this, new HighResTimerElapsedEventArgs(delay));
    ...
    public class HighResTimerElapsedEventArgs : EventArgs
    {
        /// <summary>/// Real timer delay in [ms]/// </summary>
        public double Delay { get; }

        internal HighResTimerElapsedEventArgs(double delay)
        {
            Delay = delay;
        }
    }
